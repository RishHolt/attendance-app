...
export const RegisterPageContent = () => {
  return (
    <div className="relative flex min-h-dvh items-center justify-center overflow-hidden px-4 py-8 sm:px-6 sm:py-16">
      ...
      <motion.div
        className="relative z-10 w-full max-w-full min-w-0 sm:max-w-[500px]"
      ...
      >
        <Card variant="glass" padding="lg" className="w-full p-6 sm:p-8">
          ...
          <Suspense fallback={<div className="h-64 animate-pulse rounded-lg bg-zinc-200/50 dark:bg-zinc-800/50" />}>
            <RegisterForm />
          </Suspense>
        </Card>
      </motion.div>
